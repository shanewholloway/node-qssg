...
var BasicPlugin, CommonPluginBase, CompileOnlyPlugin, CompilePlugin, FilterPlugin, JsonPlugin, ModulePlugin, MultiMatchPluginBase, NullPlugin, RenderPlugin, StaticPlugin, deepExtend, exports, makeRefError, qpluginKinds, splitExt, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
BasicPlugin = (function(_super) {
  ...
  function BasicPlugin() {
    _ref = BasicPlugin.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  BasicPlugin.prototype.context = function() {
...
FilterPlugin = (function(_super) {
  __extends(FilterPlugin, _super);

  function FilterPlugin() {
    _ref1 = FilterPlugin.__super__.constructor.apply(this, arguments);
    return _ref1;
  }

  FilterPlugin.prototype.context = function() {
    return this.render.apply(this, arguments);
  };

  FilterPlugin.prototype.render = function(entry, source, vars, callback) {
    source = this.filter(entry, source);
    return callback(null, source);
  };

  FilterPlugin.prototype.filter = function(entry, source) {
    return source;
  };
...
MultiMatchPluginBase = (function(_super) {
  ...
  function MultiMatchPluginBase() {
    _ref2 = MultiMatchPluginBase.__super__.constructor.apply(this, arguments);
    return _ref2;
  }
  ...
  MultiMatchPluginBase.prototype.registerPluginOn = function(pluginMap) {
    var ext, _i, _len, _ref3, _results;
...
NullPlugin = (function(_super) {
  ...
  function NullPlugin() {
    _ref3 = NullPlugin.__super__.constructor.apply(this, arguments);
    return _ref3;
  }
...
StaticPlugin = (function(_super) {
  ...
  function StaticPlugin() {
    _ref4 = StaticPlugin.__super__.constructor.apply(this, arguments);
    return _ref4;
  }
...
RenderPlugin = (function(_super) {
  ...
  function RenderPlugin() {
    _ref5 = RenderPlugin.__super__.constructor.apply(this, arguments);
    return _ref5;
  }

  RenderPlugin.prototype.rename = BasicPlugin.prototype.renameForFormat;

  RenderPlugin.prototype.context = function() {
    return this.render.apply(this, arguments);
  };
...
CompilePlugin = (function(_super) {
  ...
  function CompilePlugin() {
    _ref6 = CompilePlugin.__super__.constructor.apply(this, arguments);
    return _ref6;
  }

  CompilePlugin.prototype.rename = BasicPlugin.prototype.renameForFormat;

  CompilePlugin.prototype.render = RenderPlugin.prototype.render;
...
CompileOnlyPlugin = (function(_super) {
  ...
  function CompileOnlyPlugin() {
    _ref7 = CompileOnlyPlugin.__super__.constructor.apply(this, arguments);
    return _ref7;
  }
...
JsonPlugin = (function(_super) {
  ...
  function JsonPlugin() {
    _ref8 = JsonPlugin.__super__.constructor.apply(this, arguments);
    return _ref8;
  }
...
ModulePlugin = (function(_super) {
  ...
  function ModulePlugin() {
    _ref9 = ModulePlugin.__super__.constructor.apply(this, arguments);
    return _ref9;
  }
