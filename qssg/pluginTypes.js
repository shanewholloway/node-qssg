...
var BasicPlugin, CommonPluginBase, CompileOnlyPlugin, CompilePlugin, JsonPlugin, ModulePlugin, MultiMatchPluginBase, NullPlugin, RenderPlugin, StaticPlugin, deepExtendHash, exports, makeRefError, qpluginKinds, splitExt,
...
deepExtendHash = function(hash, other) {
  var d, k, q, tgt, v, _ref;
  q = [[hash, other]];
  while (q.length) {
