...
BasePlugin = (function() {
  ...
  if (0) {
    ({
      adapt: function(pluginMap, entry, matchKey) {
        return this;
      },
      bindContent: function(entry, tree, callback) {
        var renderFn,
          _this = this;
      ...
      rename: function(entry, tree) {
        return entry;
      },
      subTree: function(entry, subTree, tree, callback) {
        return this.notImplemented('subTree', callback);
      },
      ctxTree: function(entry, ctxTree, tree, callback) {
