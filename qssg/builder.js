...
var SiteBuilder, crypto, events, inspect, path, qutil, url,
...
SiteBuilder = (function(_super) {
    ...
    return this.contentTree.visit(function(vkind, citem, keyPath) {
      ...
      fsTasks.push(function(taskDone) {
        return _this.fs.stat(rx.fullPath, taskDone.wrap(function(err, stat) {
          var h, next, renderAnswer, renderDone, rs;
          if (stat != null) {
            rx.mtime = stat.mtime;
          ...
          h = _this.newHash();
          rs = _this.fs.createReadStream(rx.fullPath);
  ...
  SiteBuilder.prototype.newHash = function() {
  ...
  SiteBuilder.prototype.renderAnswerEx = function(done, rx, err, what) {
    var enc, hl, mtime, whatHash, _i, _len, _ref, _ref1, _ref2,
      _this = this;
    if (err != null) {
      done();
    ...
    if (((_ref1 = rx.content) != null ? _ref1.dstHash : void 0) && (what.pipe == null)) {
      hl = [];
      _ref2 = ['utf8', 'binary'];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        enc = _ref2[_i];
        whatHash = this.newHash().update(what, enc).digest('hex');
