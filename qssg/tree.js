...
BasicTreeDispatch = (function(_super) {
  ...
  if (0) {
    ({
      match_file: function(entry, plugin) {},
      match_dir: function(entry, plugin) {}
    });
  }

  if (0) {
    ({
      match_simple: function(entry, plugin) {},
      match_simple_dir: function(entry, plugin) {},
      match_simple_file: function(entry, plugin) {}
    });
  }
  ...
  if (0) {
    ({
      match_context: function(entry, plugin) {},
      match_context_dir: function(entry, plugin) {},
      match_context_file: function(entry, plugin) {}
    });
  }
  ...
  if (0) {
    ({
      match_composite: function(entry, plugin) {},
      match_composite_dir: function(entry, plugin) {},
      match_composite_file: function(entry, plugin) {}
    });
  }
