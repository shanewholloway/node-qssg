...
var KindBasePlugin, KindPlugin, MetadataPlugin, PluginCompositeTasks, TemplatePlugin, pluginTypes, qutil,
...
PluginCompositeTasks = (function() {
  ...
  PluginCompositeTasks.prototype.bindTaskFn = function(tasks, ns) {
    var _this = this;
  ...
  PluginCompositeTasks.prototype.bindRenderTasks = function(tasks) {
    var pi, _i, _len, _ref;
    if (tasks == null) {
      tasks = [];
    }
...
KindBasePlugin = (function(_super) {
  ...
  function KindBasePlugin() {
    return KindBasePlugin.__super__.constructor.apply(this, arguments);
  }
