...
Site = (function(_super) {
  ...
  Site.prototype.invokeBuildTasks = function() {
    var args, err, fn, taskFn, tasks, vars, _i, _len, _ref;
    vars = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    tasks = qutil.createTaskTracker.apply(qutil, args);
  ...
  Site.prototype.build = function(rootPath, rootUrl, vars, callback) {
    var bldr,
      _this = this;
    if (vars == null) {
      vars = {};
    ...
    if (!(typeof rootUrl.match === "function" ? rootUrl.match(/^https?:\/\//) : void 0)) {
